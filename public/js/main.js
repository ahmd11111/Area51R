...
document.addEventListener('DOMContentLoaded', function() {
  document.querySelectorAll('button, .btn, .payment-option').forEach(function(btn) {
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const paymentOptions = document.querySelectorAll('.payment-option input[name="paymentMethod"]');
